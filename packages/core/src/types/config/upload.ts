export interface uploadConfig {
  ...
  /** 压缩视频，开启后会将视频文件压缩后再上传，适合上传大文件。可通过「压制编码预设」选择 GPU 或 CPU 编码器 */
  compress: boolean
  ...
  /** 视频压制编码预设 */
  compressPreset: 'auto' | 'nvidia' | 'intel' | 'amd' | 'cpu' | 'custom'

  /** 自定义视频编码参数，仅在 compressPreset 为 custom 时生效 */
  compressCustomArgs: string
