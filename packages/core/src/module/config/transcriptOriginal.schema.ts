...
export const transcriptOriginalConfigSchema: SectionSchema = {
  key: 'transcriptOriginal',
  title: '转写原文相关',
  subtitle: '此处用于管理字幕/ASR 原文整理的专用设置',
  fields: [
    { type: 'divider', title: '转写原文配置' },
    {
      key: 'switch',
      type: 'switch',
      label: '启用转写原文',
    ...
    },
    {
      ...
      disabled: $not('switch'),
      rules: [{ min: 0, max: 3600, error: '请输入一个范围在 0 到 3600 之间的数字' }]
    },
    {
