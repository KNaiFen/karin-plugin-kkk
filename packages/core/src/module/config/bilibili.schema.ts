  ...
  fields: [
    ...
    },
    {
      ...
      options: [
        ...
        { label: '视频文件', value: 'video', description: '对视频稿件和直播片段有效' }
      ]
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        { label: '图文动态', value: 'image' },
        { label: '专栏', value: 'article' },
        { label: '直播', value: 'live' },
        { label: '纯文动态', value: 'text' }
      ]
    },
    ...
    {
      key: 'push.riskCooldownMs',
      type: 'input',
      inputType: 'number',
      label: '风控冷却时长（毫秒）',
      description: '命中 B站 风控后，本轮起暂停多久再恢复推送',
      color: 'warning',
      disabled: $or($not('push.switch'), $not('push.riskCooldownEnabled')),
