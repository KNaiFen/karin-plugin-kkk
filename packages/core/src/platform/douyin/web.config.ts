...
export const DouyinWeb = (all: ConfigType) => {
  const plainTitleReply = normalizePlainTitleReplyConfig(all.douyin.plainTitleReply, ['video', 'image', 'article', 'live'])
        ...
        components.accordion.createItem('cfg:douyin', {
          ...
          children: [
            ...
            components.checkbox.group('plainTitleReply:types', {
              ...
              isDisabled: !all.douyin.switch || !plainTitleReply.switch,
              checkbox: [
            ...
            components.input.number('liveRecordSeconds', {
              ...
              defaultValue: all.douyin.liveRecordSeconds.toString(),
              isDisabled: !all.douyin.switch || !all.douyin.sendContent.includes('video'),
              rules: [{ min: 1, max: 120 }]
            }),
            components.radio.group('liveQuality', {
              ...
              orientation: 'horizontal',
              defaultValue: all.douyin.liveQuality.toString(),
              isDisabled: !all.douyin.switch || !all.douyin.sendContent.includes('video'),
              radio: [
            ...
            components.switch.create('longTitleFullText', {
              label: '长标题发送全文',
              description: '主动解析非文章、非直播作品时，标题超过配置阈值后，图片模式渲染全文卡，文本模式直接发送全文',
              defaultSelected: all.douyin.longTitleFullText,
              isDisabled: !all.douyin.switch
            }),
            components.input.number('longTitleFullTextThreshold', {
              label: '长标题触发字数',
              description: '按 Unicode 字素计算，标题长度大于该值时触发，默认 25',
              defaultValue: all.douyin.longTitleFullTextThreshold.toString(),
              isDisabled: !all.douyin.switch || !all.douyin.longTitleFullText,
            ...
            components.input.number('push:jitterSeconds', {
              ...
              defaultValue: String(all.douyin.push.jitterSeconds ?? 0),
              color: 'warning',
              isDisabled: !all.douyin.push.switch,
