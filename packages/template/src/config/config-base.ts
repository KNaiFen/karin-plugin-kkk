...
export const baseComponentConfigs: BasePlatformConfig[] = [
  {
    ...
    components: [
      ...
      },
      {
        id: 'long-text-work',
        name: '长文本作品',
        description: '抖音非文章长文本作品模板',
        enabled: true,
        componentPath: 'platforms/douyin/LongTextWork',
        exportName: 'DouyinLongTextWork'
      },
      {
        id: 'favorite-list',
        name: '喜欢列表',
  ...
  },
  {
    ...
    components: [
      ...
      },
      {
        id: 'external-post',
        name: '外部帖子卡片',
        description: '知乎/贴吧/小黑盒内容展示模板',
        enabled: true,
        componentPath: 'platforms/other/ExternalPost',
        exportName: 'ExternalPostCard'
      }
    ]
  },
  {
